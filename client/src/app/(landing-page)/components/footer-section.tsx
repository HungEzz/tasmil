    ...
    <section className="relative w-full overflow-hidden text-white h-[90vh] md:h-[100vh] flex flex-col">
      ...
      <div className="flex-1 z-10 px-4 md:px-10 pt-14 pb-4 md:pt-24 md:pb-6 flex flex-col justify-between">
        ...
        <div className="max-w-4xl">
          <Typography
            ...
            weight="bold"
            gradient
            className="text-4xl leading-tight mb-6 max-w-2xl"
          >
          ...
          <Typography
            as="div"
            className="text-lg md:text-xl md:w-[60%] mb-6 md:mb-10 mt-4 md:mt-6 opacity-90 max-w-2xl text-white"
          >
          ...
          >
            ...
            <Typography className="text-black text-sm sm:text-base uppercase tracking-wide px-2 sm:px-3 transition-all duration-300 group-hover:tracking-wider">
      ...
      <div className="hidden sm:block absolute right-4 sm:right-10 bottom-[25%] sm:bottom-[20%] z-20">
        ...
        >
          ...
          <Typography className="mt-2 text-center text-white/80 group-hover:text-white transition-colors duration-300 text-sm">
            Back to top
          </Typography>
        </button>
      </div>
