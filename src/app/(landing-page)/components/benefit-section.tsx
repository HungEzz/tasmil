...
import { FiMessageCircle, FiTool, FiGlobe } from "react-icons/fi";
      ...
      <div className="container relative z-10 mx-auto px-4 md:px-8">
        ...
        >
          <Typography
            as="span"
            gradient={true}
            className={`text-sm md:text-base opacity-80 uppercase mb-3 transition-all duration-700 ${
              isLoaded
          ...
          <Typography
            ...
            weight="semibold"
            gradient={true}
            className={`text-3xl md:text-5xl uppercase font-semibold transition-all duration-700 delay-200 ${
              isLoaded
                ? "opacity-100 translate-x-0"
                : "opacity-0 translate-x-10"
            }`}
