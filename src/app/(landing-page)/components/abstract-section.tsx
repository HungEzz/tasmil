...
export const AbstractSection = () => {
  ...
  return (
    <section className="relative md:h-screen h-[50vh] w-full overflow-hidden py-20 bg-black">
      ...
      <div
        className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[75vw] h-[75vw] md:w-[45vw] md:h-[45vw] transition-all duration-1000 z-30 ${
