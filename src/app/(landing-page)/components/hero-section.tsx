          ...
          {isMobile ? (
            ...
            <div className="text-center flex flex-col items-center gap-4 w-auto">
              ...
              <div className="my-3 max-w-lg">
                ...
                >
                  Experience seamless token swaps, and real-time market insights
              ...
              <div className="flex flex-col items-center gap-8">
                <div className="flex flex-col gap-2 text-center">
                  <Typography
                    variant="h1"
                    gradient={true}
                    className="text-center uppercase text-5xl xl:text-5xl font-bold"
                  >
                    Your Intelligent DeFi
                  </Typography>
                  <Typography
                ...
                <div className="max-w-xl">
                  ...
                  >
                    Experience seamless token swaps, liquidity management, and
                    real-time market insights with our AI-powered DeFi chatbot.
                  </Typography>
                </div>
